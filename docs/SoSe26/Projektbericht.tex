...
\begin{abstract}
  ...
  Eine besonderer Schwerpunkt der ARbeit lag auf der Verbesserung des Beitrittsporzesses sowie auch der Möglichtleit einer 
  neuen Antwortauswahl, jedocch war die Optimierung der Benutzeroberfläche und der Benutzererfahrung (UI/UX) auch ein 
  zentrales Ziel der Arbeit.
